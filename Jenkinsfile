        ...
        stage ('Deployments'){
            parallel{
                stage ('Deploy to Staging'){
                    steps {
                        sh "scp -i C:/Users/I7Dell/.ssh/tomcat-key.pem 'C:/Users/I7Dell/projects/maven-project/webapp/target/webapp.war' ec2-user@3.82.246.59:/var/lib/tomcat7/webapps"
                    }
                }
